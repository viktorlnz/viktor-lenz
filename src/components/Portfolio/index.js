    ...
    return (
        <>
            <section id='section-main'>
                <article>
                    <section id='section-apresentacao' class='space'>
                        <h2>Quem sou eu</h2>
                        <p>
                    ...
                    <section id='section-ficha' class='space'>
                        <h2>Ficha técnica</h2>
                        <p>Eis uma ficha que me resume:</p>
                        <div id='div-ficha' class='space'>
                            <h3>Viktor Lenz</h3>
                            <ul id='ul-dados-base' class='space'>
                            ...
                            <ul id='ul-dados-tecnicos' class='space'>
                            ...
                            <section id='section-dados-dev' class='space'>
                                <h4>Habilidades com informática</h4>
                                <div id='div-linguagens' class='space'>
                                ...
                                <div id='div-tecnologias' class='space'>
                                ...
                                <div id='div-adicionais' class='space'>
                                    <h5>Adicionais</h5>
                                    <ul class='space'>
                                        <li>Usos do Git</li>
                            ...
                            <section id='section-dados-informais' class='space'>
